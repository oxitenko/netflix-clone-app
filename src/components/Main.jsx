    ...
    return (<div className="w-full h-[550px] text-white">
        <div className="w-full h-full">
            ...
            <img className="w-full h-full object-cover"
                 src={`https://image.tmdb.org/t/p/original${randomMovie?.backdrop_path}`} alt={randomMovie?.title}/>
            <div className="absolute w-full top-[20%] p-4 md:p-8">
                ...
                <p className="w-full md:max-w-[70%] lg:max-w-[50%] xl:max-w-[35%] text-gray-200">{cutString(randomMovie?.overview, 150)}</p>
            </div>
        </div>
    </div>);
};
